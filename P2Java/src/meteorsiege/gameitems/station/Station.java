 ...
 * gére un systéme d'argent, de scores et de dégats via un bouclier et Upgrade via l'Upgrader <br>
 * </p>
 * @see Shield
 * @see Upgrader
 */
public class Station extends Circle
	 ...
	 * @param life : quantit� de vie de la station
	 * @param shield : quantit� de vie du bouclier
	 ...
	 * Pour le reste des caractèristiques voire : {@link Upgrader}
	 */
	public void reset()
		{
		shield.reset();
